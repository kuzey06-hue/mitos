...
export default function ResearchHero() {
  ...
  return (
    <section ref={ref} className="relative w-full min-h-[60vh] flex items-center justify-center px-6 md:px-10 py-24 md:py-28 bg-background-50">
      <div className={`max-w-4xl text-center transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <p className="mt-8 text-foreground-400 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
          {t('hero.description')}
        </p>
